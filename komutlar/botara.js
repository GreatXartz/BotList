...
exports.run = async (client, msg, args) => {
    ...
    request(`https://listdcbotga.glitch.me/api/botlar/${args[0]}`, function (error, response, body) {
    if (error) return msg.channel.send('Hata:', error);
      ...
      request(`https://listdcbotga.glitch.me/api/tumbotlar`, function (errorr, responsee, bodyy) {
    ...
    .setFooter('https://list.DCBots.Ga sisteminde bot aramaktadır.')
...
exports.help = {
  name: 'bot-ara',
  description: 'DCBots.Ga sistemindeki botları aramanızı sağlar.',
